...
-- A: I will make three tables with one being the bridge table that relates the employees table and expertise category table. 
-- The bridge table will connect 
-- Q: What type of relationship is this? (e.g. 1-1, 1-many, or many-to-many?)
-- A: This relationship would be a many-to-many relationship. Many employees can be experts in zero or more categories.
